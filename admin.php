...
<body>
  ...
  <div class="container-fluid ">
      <div class="row">
        <div class="col">
          <h1 class="mt-5">Manager Users</h1>
        </div>
      </div>
      <button type="button" class="btn btn-primary mt-5 mb-5">Add New Users</button>
      <table class="table ">
  <thead>
    <tr>
      <th scope="col">S.N.</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Duong</td>
      <td>minamoto</td>
      <td> <a href="#"><button type="button" class="btn btn-primary">Change Password</button> </a> <a href="#"><button type="button" class="btn btn-success">Update Admin</button> </a> <a href="#"><button type="button" class="btn btn-danger">Delete Admin</button> </a></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Duong</td>
