...
<body>
    ...
    <div class="bg-light">
        <div class="container-fluid  ">
            <div class="row">
                <div class="col">
                    <h1 class="mt-5">Manager Food</h1>
                </div>
            </div>
            <button type="button" class="btn btn-primary mt-5 mb-5">Add Food</button>
            <table class="table ">
                <thead>
                    <tr>
                ...
                <tbody class="border-style-none">
                    <tr>
                        ...
                        <td>$5.0</td>
                        <td class="p-0 col-2"><img src="Css/img/menu-momo.jpg" class="img-admin"></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td> <a href="#"><button type="button" class="btn btn-success">Update Food</button> </a> <a href="#"><button type="button" class="btn btn-danger">Delete Food</button> </a></td>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>Best Burger</td>
                        <td>$4.0</td>
                        <td class="p-0 col-2"><img src="Css/img/menu-burger.jpg" class="img-admin"></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td> <a href="#"><button type="button" class="btn btn-success">Update Food</button> </a> <a href="#"><button type="button" class="btn btn-danger">Delete Food</button> </a></td>
                        </td>
                    ...
                    <tr>
                        <th scope="row">3</th>
                        <td>Somky BBQ Pizza</td>
                        <td>$6.0</td>
                        <td class="p-0 col-2"><img src="Css/img/menu-pizza.jpg" class="img-admin"></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td> <a href="#"><button type="button" class="btn btn-success">Update Food</button> </a> <a href="#"><button type="button" class="btn btn-danger">Delete Food</button> </a></td>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>$52.0</td>
                        <td class="p-0 col-2"><p class="Cancelled" >Image Not Added</p></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td> <a href="#"><button type="button" class="btn btn-success">Update Food</button> </a> <a href="#"><button type="button" class="btn btn-danger">Delete Food</button> </a></td>
                        </td>
